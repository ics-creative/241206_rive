...
(e = (() => {
    ...
    N = [
        ...
        const i =
          ...
          (e = {}) => {
            function t() {
              ...
              (this.requestAnimationFrame = function (i) {
                ...
                (this.cancelAnimationFrame = (e) => {
                  r.delete(e),
                    t && 0 == r.size && (cancelAnimationFrame(t), (t = 0));
                }),
                (this.Rb = (e) => {
                  ...
                  setTimeout(() => {
                    t.delete(r),
                      0 == t.length
                        ? (n = -1 / 0)
                        : r == n &&
                          console.assert((n = Math.max(...t.keys())) < r);
                  }, 1e3),
                ),
                (n = Math.max(r, n)) << e
              );
            ...
            e.onRuntimeInitialized = () => {
              i && i();
              const t = e.decodeAudio;
              e.decodeAudio = (e, n) => {
                n((e = t(e)));
              };
              const n = e.decodeFont;
              e.decodeFont = (e, t) => {
                t((e = n(e)));
              };
              const r = e.FileAssetLoader;
              (e.ptrToAsset = (t) => {
                const n = e.ptrToFileAsset(t);
                return n.isImage
                  ? e.ptrToImageAsset(t)
                  : n.isFont
                    ? e.ptrToFontAsset(t)
                ...
                (e.FallbackFileAssetLoader = r.extend(
                  "FallbackFileAssetLoader",
                  {
                    ...
                    loadContents: function (e, t) {
                      for (const n of this.kb)
                        if (n.loadContents(e, t)) return !0;
                      return !1;
                    },
                  },
                ));
              const a = e.computeAlignment;
                ...
                (this.Qb = (n, r, i, c, p) => {
                  if (e()) {
                    ...
                    if (t.canvas) {
                      ...
                      (m = f.push(c)),
                      s != m &&
                        (t.bufferData(t.ARRAY_BUFFER, 8 * m, t.DYNAMIC_DRAW),
                        (s = m)),
                      (m = 0),
                      i))
                      ...
                      for (const e of (console.assert(g == 2 * p),
                      (y = 0),
                      (b = !0),
                      (m = g = 0),
                      i)) {
                        e.image.Ka != y &&
                          ...
                          (y = e.image.Ka)),
                          e.mc
                            ? (t.scissor(e.Ya, v - e.Za - e.jb, e.Ac, e.jb),
                              (b = !0))
                            : b && (t.scissor(0, v - r, n, r), (b = !1)),
                          (i = 2 / n);
                        const s = -2 / r;
                        t.uniform4f(
                          a,
                          ...
                          t.uniform2f(
                            o,
                            e.ha[4] * i * e.Ba + i * (e.Ya - e.ic * e.Ba) - 1,
                            e.ha[5] * s * e.Ca + s * (e.Za - e.jc * e.Ca) + 1,
                          ),
            ...
            e.onRuntimeInitialized = () => {
              ...
              var y = e.RenderImage.extend("CanvasRenderImage", {
                  ...
                  __destruct: function () {
                    this.Ja && (o.Mb(this.Ja), URL.revokeObjectURL(this.Wa)),
                      this.__parent.__destruct.call(this);
                  },
                  decode: function (e) {
                    this.xa && this.xa(this);
                    var n = new Image();
                    (this.Wa = URL.createObjectURL(
                ...
                _ = l.extend("CanvasRenderPaint", {
                  ...
                  radialGradient: function (e, t, n, r) {
                    this.ja = { yb: e, zb: t, bb: n, cb: r, Ra: [], ec: !0 };
                  },
                ...
                _drawImageMesh: function (t, r, a, s, u, c, l, h, f, d) {
                  ...
                  if (
                    ...
                    (m = o.hc()),
                      w > m && ((d *= m / w), (w = m)),
                      _ > m && ((p *= m / _), (_ = m)),
                      C || (C = new e.DynamicRectanizer(m)).reset(512, 512),
                      0 > (m = C.addRect(w, _)) &&
                        (i(),
                        A.add(this),
                    ...
                    this.H.push(() => {
                      M.save(),
                        ...
                        (M.globalAlpha = a);
                      const e = o.canvas();
                      e && M.drawImage(e, P, L, w, _, l, h, b, y), M.restore();
                    });
                  }
                },
              ...
              (e.makeRenderer = (e) => {
                ...
                (e.renderFactory = {
                  makeRenderPaint: () => new _(),
                  makeRenderPath: () => new w(),
                  makeRenderImage: () => {
                    const e = M;
                    return new y({
                      xa: () => {
              ...
              let L = e.load,
                M = null;
              e.load = (t, n, r = !0) => {
                const i = new e.FallbackFileAssetLoader();
                return (
              ...
              const F = e.RendererWrapper.prototype.align;
            ...
            if (!X((q = "canvas_advanced.wasm"))) {
              var H = q;
              q = e.locateFile ? e.locateFile(H, _) : _ + H;
            }
            function V(e) {
            ...
            function G(e, t, n) {
              return ((e) => {
                ...
                .then((e) => e)
                .then(n, (e) => {
                  C("failed to asynchronously prepare wasm: " + e), z(e);
                });
            }
            var q,
              J,
              ...
              Z = {
                  ...
                  if (void 0 === window.h) {
                    ...
                    (a.D = []),
                      ...
                      (a.Cb = (e) => {
                        for (
                          a.D[e] = null;
                          0 < a.D.length && null == a.D[a.D.length - 1];
                        )
                          a.D.pop();
                      }),
                      (a.Sc = (e) => {
                ...
                449058: (e) => window.h.ra(e).J.sampleRate,
                449131: (e) => {
            ...
            var eg,
              ...
              e_ = {
                  ...
                  return (
                    e_.O ||
                      (e_.O = {
                        ...
                        $a: { node: { Y: e_.l.Y, P: e_.l.P }, stream: eN },
                      }),
                    16384 == (61440 & (n = eO(e, t, n, r)).mode)
                      ? ((n.l = e_.O.dir.node),
                        (n.m = e_.O.dir.stream),
                        (n.j = {}))
                      : 32768 == (61440 & n.mode)
                ...
                l: {
                  ...
                  sb(e) {
                    var t,
                      n = [".", ".."];
                    for (t in e.j) Object.hasOwn(e.j, t) && n.push(t);
                    return n;
                  },
                  Ea: (e, t, n) => (
                ...
                m: {
                  ...
                  pa(e, t, n) {
                    ev(e.node, t + n), (e.node.v = Math.max(e.node.v, t + n));
                  },
                  lb(e, t, n, r, i) {
                    if (32768 != (61440 & e.node.mode)) throw new eL(43);
                ...
                for (var n = eA, r = "/", i = 0; i < e.length; i++) {
                  ...
                  if (
                    ...
                    for (a = 0; 40960 == (61440 & n.mode); )
                      if (
                        ((n = eV(r)),
                        (n = eF((r = eo(en(r), n)), { Qa: t.Qa + 1 }).node),
                        40 < a++)
                      )
                        throw new eL(32);
                  }
              ...
              eX = (e, t, n) => {
                void 0 === n && ((n = t), (t = 438)), ez(e, 8192 | t, n);
              },
              eH = (e, t) => {
              ...
              eG = (t, n, r) => {
                ...
                if (
                  ((r = 64 & n ? ((void 0 === r ? 438 : r) & 4095) | 32768 : 0),
                  "object" == typeof t)
                )
                  var a = t;
                else {
                ...
                if (
                  ...
                  (r = a
                    ? 40960 == (61440 & a.mode)
                      ? 32
                      : 16384 == (61440 & a.mode) && ("r" !== eI(n) || 512 & n)
                        ? 31
                        : ek(a, eI(n))
                    : 44)
                )
                ...
                if (512 & n && !i) {
                  if (
                    !(r =
                      "string" == typeof (r = a) ? eF(r, { fb: !0 }).node : r).l
                      .P
                  )
                    throw new eL(63);
            ...
            function tl(e, t) {
              var n = tu[e];
              return void 0 === n && e5(t + " has unknown type " + tc(e)), n;
            }
            function th() {}
            var tf = !1;
            function td(e) {
            ...
            function tg(e, t) {
              return (
                (t.u && t.o) || tv("makeClassHandle requires ptr and ptrType"),
                !!t.L != !!t.G &&
            ...
            function tM(e, t, n) {
              if (void 0 === e[t].B) {
                ...
                (e[t] = function () {
                  return (
                    Object.hasOwn(e[t].B, arguments.length) ||
                      e5(
            ...
            function tO(e, t) {
              if (null === t) {
                if (
                  (this.Na && e5(`null is not a valid ${this.name}`), this.ua)
                ) {
                  var n = this.Pa();
            ...
            function tk(e, t, n, r) {
              (this.name = e),
                ...
                void 0 !== t.A
                  ? (this.toWireType = tO)
                  : ((this.toWireType = r ? tj : tI), (this.K = null));
            }
            function tD(t, n, r) {
              Object.hasOwn(e, t) || tv("Replacing nonexistant public symbol"),
            ...
            function tN(e, t) {
              ...
              return (
                "function" != typeof n &&
                  e5(`unknown function pointer with signature ${e}: ${t}`),
                n
              );
            }
            var t$ = void 0;
            ...
            function tz(e, t, n, r, i) {
              ...
              return function () {
                ...
                for (var a = 0; a < c; ++a)
                  (l[a] = t[a + 2].toWireType(f, arguments[a])), h.push(l[a]);
            ...
            function tX(e, t) {
              for (var n = [], r = 0; r < e; r++) n.push(x[(t + 4 * r) >> 2]);
              return n;
            }
            function tH(e, t, n) {
              return (
                e instanceof Object || e5(`${n} with invalid "this": ${e}`),
            ...
            var t3,
              ...
              t7 = () => {
                if (!t3) {
                  ...
                  for (e in t9) void 0 === t9[e] ? delete t[e] : (t[e] = t9[e]);
                  var n = [];
              ...
              nr = (e, t, n, r) => {
                ...
                (n = n.replace(/%%/g, "\0\0")),
                c))
                  n.includes(l) && (n = n.replace(RegExp(l, "g"), c[l](r)));
                return (l = ef((n = n.replace(/\0\0/g, "%")), !1)).length > t
                  ? 0
            ...
            (tt = na),
              (e.getInheritedInstanceCount = () => Object.keys(to).length),
              (e.getLiveInheritedInstances = () => {
                var e,
                  t = [];
                for (e in to) Object.hasOwn(to, e) && t.push(to[e]);
                return t;
              }),
              ...
              (t$ = e.UnboundTypeError = e7("UnboundTypeError"));
            var ns = {
              __syscall_fcntl64: (e, t, n) => {
                eQ = n;
                try {
                  var r = eB(e);
                  switch (t) {
              ...
              _embind_create_inheriting_constructor: (e, t, n) => {
                ...
                (a.__destruct = function () {
                  ...
                  (e = ts(i, e)),
                    Object.hasOwn(to, e)
                      ? delete to[e]
                      : e5(`Tried to unregister unregistered instance: ${e}`);
                }),
              ...
              _embind_register_bool: (e, t, n, r, i) => {
                var a = tE(n);
                tT(e, {
                  name: (t = tn(t)),
                  fromWireType: (e) => !!e,
                  toWireType: (e, t) => (t ? r : i),
                  argPackAdvance: 8,
              ...
              _embind_register_class: (
                ...
                tF(d, () => {
                  ...
                  tR([e, t, n], r ? [r] : [], (t) => {
                    ...
                    var o = Object.create(i, {
                      constructor: {
                        value: (t = e2(d, function () {
                          ...
                          if (void 0 === u.$)
                            throw new e6(l + " has no accessible constructor");
                          var e = u.$[arguments.length];
                          if (void 0 === e)
                            throw new e6(
                              `Tried to invoke ctor of ${l} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(u.$).toString()}) parameters instead!`,
                            );
                    ...
                    u.A && (void 0 === u.A.oa && (u.A.oa = []), u.A.oa.push(u)),
                      (n = new tk(l, u, !0, !1)),
                      (i = new tk(l + "*", u, !1, !1));
                    var h = new tk(l + " const*", u, !1, !0);
                    return (
                      (tp[e] = { pointerType: i, Kb: h }), tD(d, t), [n, i, h]
                    );
                  });
              },
                ...
                (t = tn(t)),
                  ...
                  tR([], [e], (e) => {
                    ...
                    var i = `${e.name}.${t}`,
                      u = {
                        get() {
                          tY(`Cannot access ${i} due to unbound types`, [n]);
                        },
                        enumerable: !0,
                        configurable: !0,
                      };
                ...
                (t = tn(t)),
                  ...
                  tR([], [e], (e) => {
                    ...
                    var r = `${e.name}.${t}`,
                      l = {
                        get() {
                          tY(`Cannot access ${r} due to unbound types`, [n, o]);
                        },
                        enumerable: !0,
                        configurable: !0,
                      };
                    return (
                      (l.set = u
                        ? () => {
                            tY(`Cannot access ${r} due to unbound types`, [
                              n,
                              o,
                            ]);
                          }
                  ...
                  tT(e, {
                    ...
                    readValueFromPointer: ((e, t, n) => {
                      switch (t) {
                        ...
                        case 1:
                          return function (e) {
                            return this.fromWireType((n ? M : F)[e >> 1]);
                          };
                        case 2:
                          return function (e) {
                            return this.fromWireType((n ? S : x)[e >> 2]);
                          };
                        default:
              ...
              _embind_register_enum_value: (e, t, n) => {
                ...
                (t = tn(t)),
                  ...
                  (r = Object.create(r.constructor.prototype, {
                    value: { value: n },
                    constructor: { value: e2(`${r.name}_${t}`, () => {}) },
                  })),
                  (e.values[n] = r),
                  (e[t] = r);
              },
                ...
                (e = tn(e)),
                  ...
                  tR(
                    ...
                    (n) => (
                      tD(
                        e,
                        tz(e, [n[0], null].concat(n.slice(1)), null, i, a),
                        t - 1,
                      ),
                      []
                    ),
              ...
              _embind_register_integer: (e, t, n, r, i) => {
                ...
                (n = t.includes("unsigned") ? (e, t) => t >>> 0 : (e, t) => t),
                  tT(e, {
                    name: t,
                    fromWireType: a,
                    toWireType: n,
                    ...
                    readValueFromPointer: ((e, t, n) => {
                      switch (t) {
                        case 0:
                          return n ? (e) => P[e] : (e) => L[e];
                        case 1:
                          return n ? (e) => M[e >> 1] : (e) => F[e >> 1];
                        case 2:
                          return n ? (e) => S[e >> 2] : (e) => x[e >> 2];
                        default:
                          throw TypeError("Unknown integer type: " + e);
                      }
                    })(t, i, 0 !== r),
              ...
              _embind_register_std_wstring: (e, t, n) => {
                if (((n = tn(n)), 2 === t))
                  ...
                  4 === t &&
                    ((r = tQ), (i = t0), (a = t1), (o = () => x), (s = 2));
                tT(e, {
                  name: n,
                  fromWireType: (e) => {
                    for (
                      var n, i = x[e >> 2], a = o(), u = e + 4, c = 0;
                      c <= i;
                      ++c
                    ) {
                      var l = e + 4 + c * t;
                  ...
                  toWireType: (e, r) => {
                    "string" != typeof r &&
                      e5(`Cannot pass non-string to C++ string type ${n}`);
                    var o = a(r),
                      u = nc(4 + o + t);
                    return (
                      (x[u >> 2] = o >> s),
              ...
              _embind_register_value_object: (e, t, n, r, i, a) => {
                ty[e] = { name: tn(t), Pa: tN(n, r), W: tN(i, a), eb: [] };
              },
              ...
              _emval_call_void_method: (e, t, n, r) => {
                (e = t6[e])((t = e8(t)), (n = t4(n)), null, r);
              },
              _emval_decref: tV,
              _emval_get_method_caller: (e, t) => {
                var n,
                  r,
                  i = ((e, t) => {
                    for (var n = Array(e), r = 0; r < e; ++r)
                      n[r] = tl(x[(t + 4 * r) >> 2], "parameter " + r);
                    return n;
                  })(e, t),
                  a = i[0],
                  o =
              ...
              _emval_get_module_property: (t) => e9(e[(t = t4(t))]),
              _emval_get_property: (e, t) => e9((e = e8(e))[(t = e8(t))]),
              _emval_incref: (e) => {
                4 < e && (e3.get(e).tb += 1);
              },
              _emval_new_cstring: (e) => e9(t4(e)),
              _emval_new_object: () => e9({}),
              ...
              _emval_take_value: (e, t) =>
                e9(
                  (e = (e = tl(e, "_emval_take_value")).readValueFromPointer(
                    t,
                  )),
                ),
              abort: () => {
              ...
              emscripten_asm_const_int: (e, t, n) => {
                ...
                for (t8.length = 0, n >>= 2; (r = L[t++]); )
                  (n += (105 != r) & n),
                    t8.push(105 == r ? S[n] : O[n++ >> 1]),
                    ++n;
                return Z[e].apply(null, t8);
              },
              emscripten_date_now: () => Date.now(),
              emscripten_get_now: () => performance.now(),
              emscripten_memcpy_big: (e, t, n) => L.copyWithin(e, t, t + n),
              ...
              environ_get: (e, t) => {
                ...
                return (
                  t7().forEach((r, i) => {
                    var a = t + n;
                    for (i = x[(e + 4 * i) >> 2] = a, a = 0; a < r.length; ++a)
                  ...
                  e: {
                    ...
                    for (var a, o = (t = 0); o < n; o++) {
                      ...
                      if (null === i.X || 1 == (2097155 & i.flags))
                        throw new eL(8);
                      if (16384 == (61440 & i.node.mode)) throw new eL(31);
            ...
            var nh = (e._ma_device_process_pcm_frames_capture__webaudio = (
                ...
                (nh = e._ma_device_process_pcm_frames_capture__webaudio =
                  T.ma_device_process_pcm_frames_capture__webaudio)(t, n, r)),
              nf = (e._ma_device_process_pcm_frames_playback__webaudio = (
                ...
                (nf = e._ma_device_process_pcm_frames_playback__webaudio =
                  T.ma_device_process_pcm_frames_playback__webaudio)(t, n, r)),
              nd = () => (nd = T.__errno_location)(),
              np = (e) => (np = T.__getTypeName)(e);
            function nm() {
              function t() {
                if (!f && ((f = !0), (e.calledRun = !0), !I)) {
                  if (
                    (e.noFSInit ||
                      eg ||
                      ((eg = !0),
                      ...
                      e.stdin
                        ? eK("stdin", e.stdin)
                        : eH("/dev/tty", "/dev/stdin"),
                      e.stdout
                        ? eK("stdout", null, e.stdout)
                        : eH("/dev/tty", "/dev/stdout"),
                      e.stderr
                        ? eK("stderr", null, e.stderr)
                        : eH("/dev/tty1", "/dev/stderr"),
                      eG("/dev/stdin", 0),
                      eG("/dev/stdout", 1),
                      eG("/dev/stderr", 1)),
                    (eP = !1),
            ...
            if (
              ...
              (e.dynCall_viijii = (t, n, r, i, a, o, s) =>
                (e.dynCall_viijii = T.dynCall_viijii)(t, n, r, i, a, o, s)),
              (e.dynCall_iiiiij = (t, n, r, i, a, o, s) =>
                (e.dynCall_iiiiij = T.dynCall_iiiiij)(t, n, r, i, a, o, s)),
        ...
        var r = void 0,
          i = (e, t) => {
            ...
            return ["touchstart", "touchmove"].indexOf(e.type) > -1 &&
              (null === (n = e.touches) || void 0 === n ? void 0 : n.length)
              ? (t || e.preventDefault(),
                {
              ...
              g = ((e) => {
                ...
                if (a || s) {
                  ...
                  var y = new u.Vec2D(h, d),
                    ...
                    A = w.y();
                  switch (
                    (w.delete(), b.delete(), y.delete(), g.delete(), e.type)
                  ) {
                    case "mouseout":
      ...
      (e, t, n) => {
        ...
        function l(e) {
          ...
          var t = e
            .replace(o, "")
            .replace(i, (e, t) => String.fromCharCode(t))
            .replace(a, "")
            .replace(o, "")
            .trim();
          if (!t) return c;
  ...
  function Y(e) {
    ...
    var n = ($[e] = { exports: {} });
    return N[e](n, n.exports, Y), n.exports;
  }
  (Y.d = (e, t) => {
    for (var n in t)
      Y.o(t, n) &&
  ...
  return (
      ...
      function n(n) {
        ...
        (this.fit =
          null !== (r = null == n ? void 0 : n.fit) && void 0 !== r
            ...
            : e.Contain),
          (this.alignment =
            null !== (i = null == n ? void 0 : n.alignment) && void 0 !== i
              ? i
              : t.Center),
          (this.layoutScaleFactor =
            ...
            void 0 !== a
              ...
              : 1),
          (this.minX =
            null !== (o = null == n ? void 0 : n.minX) && void 0 !== o ? o : 0),
          (this.minY =
            null !== (s = null == n ? void 0 : n.minY) && void 0 !== s ? s : 0),
          (this.maxX =
            null !== (u = null == n ? void 0 : n.maxX) && void 0 !== u ? u : 0),
          (this.maxY =
            null !== (c = null == n ? void 0 : n.maxY) && void 0 !== c ? c : 0);
      }
      return (
        (n.new = (e) => {
          var t = e.fit,
          ...
          return (
            ...
            new n({ fit: t, alignment: r, minX: i, minY: a, maxX: o, maxY: s })
          );
        }),
    ...
    (b = (() => {
      ...
      return (
        (e.loadRuntime = () => {
          s.default({ locateFile: () => e.wasmURL })
            .then((t) => {
              var n;
        ...
        (e.awaitInstance = () =>
          new Promise((t) => e.getInstance((e) => t(e)))),
        (e.setWasmUrl = (t) => {
          e.wasmURL = t;
        }),
        (e.getWasmUrl = () => e.wasmURL),
        (e.isLoading = !1),
        (e.callBackQueue = []),
    ...
    (A = (() => {
      ...
      return (
        ...
        (e.prototype.mapRuntimeInput = (e, t) =>
          e.type === t.SMIInput.bool
      ...
      return (
        (e.prototype.add = function (e, t, n) {
          if ((void 0 === n && (n = !0), 0 === (e = k(e)).length))
            this.animations.forEach((e) => (e.playing = t)),
              this.stateMachines.forEach((e) => (e.playing = t));
          else
            for (
              var r = this.animations.map((e) => e.name),
                a = this.stateMachines.map((e) => e.name),
                o = 0;
              o < e.length;
              o++
            ) {
        ...
        (e.prototype.initLinearAnimations = function (e, t) {
          for (
            var n = this.animations.map((e) => e.name), r = 0;
            r < e.length;
            r++
          ) {
            var i = n.indexOf(e[r]);
        ...
        (e.prototype.initStateMachines = function (e, t) {
          for (
            var n = this.stateMachines.map((e) => e.name), r = 0;
            r < e.length;
            r++
          ) {
            var i = n.indexOf(e[r]);
        ...
        (e.prototype.scrub = function (e, t) {
          var n = this.animations.filter((t) => e.includes(t.name));
          return n.forEach((e) => (e.scrubTo = t)), n.map((e) => e.name);
        }),
        Object.defineProperty(e.prototype, "playing", {
          get: function () {
            return this.animations
              ...
              .map((e) => e.name)
              .concat(
                this.stateMachines.filter((e) => e.playing).map((e) => e.name),
              );
          },
          enumerable: !1,
          configurable: !0,
        ...
        (e.prototype.stop = function (e) {
          ...
          if (0 === e.length)
            (n = this.animations
              .map((e) => e.name)
              .concat(this.stateMachines.map((e) => e.name))),
              this.animations.forEach((e) => e.cleanup()),
              this.stateMachines.forEach((e) => e.cleanup()),
              this.animations.splice(0, this.animations.length),
              this.stateMachines.splice(0, this.stateMachines.length);
          else {
            var r = this.animations.filter((t) => e.includes(t.name));
            r.forEach((e) => {
              e.cleanup(),
                this.animations.splice(this.animations.indexOf(e), 1);
            });
            var a = this.stateMachines.filter((t) => e.includes(t.name));
            a.forEach((e) => {
              e.cleanup(),
                this.stateMachines.splice(this.stateMachines.indexOf(e), 1);
            }),
              (n = r.map((e) => e.name).concat(a.map((e) => e.name)));
          }
        ...
        Object.defineProperty(e.prototype, "isPlaying", {
          get: function () {
            return (
              this.animations.reduce((e, t) => e || t.playing, !1) ||
              this.stateMachines.reduce((e, t) => e || t.playing, !1)
            );
          },
          enumerable: !1,
          configurable: !0,
        ...
        Object.defineProperty(e.prototype, "isStopped", {
          get: function () {
            return (
              0 === this.animations.length && 0 === this.stateMachines.length
            );
          },
          enumerable: !1,
          configurable: !0,
        ...
        (e.prototype.handleLooping = function () {
          for (
            var e = 0, t = this.animations.filter((e) => e.playing);
            e < t.length;
            e++
          ) {
            var n = t[e];
        ...
        (e.prototype.handleStateChanges = function () {
          for (
            var e = [], t = 0, n = this.stateMachines.filter((e) => e.playing);
            t < n.length;
            t++
          ) {
            var r = n[t];
    ...
    (T = (() => {
      ...
      return (
        (e.prototype.getListeners = function (e) {
          return this.listeners.filter((t) => t.type === e);
        }),
        ...
        (e.prototype.fire = function (e) {
          this.getListeners(e.type).forEach((t) => t.callback(e));
        }),
        e
      );
    })()),
    ...
    (M = new (((e) => {
      function t() {
        ...
        return (
          (t._started = !1), (t._enabled = !1), (t._status = o.UNAVAILABLE), t
        );
      }
      return (
        f(t, e),
        (t.prototype.delay = function (e) {
          return d(this, void 0, void 0, function () {
            return p(this, (t) => [2, new Promise((t) => setTimeout(t, e))]);
          });
        }),
        (t.prototype.timeout = function () {
          return d(this, void 0, void 0, function () {
            return p(this, (e) => [
              2,
              new Promise((e, t) => setTimeout(t, 50)),
            ]);
          });
        }),
            ...
            return p(this, function (e) {
              switch (e.label) {
                case 0:
                  ...
                  if (((this._started = !0), "undefined" != typeof window))
                    return [3, 1];
    ...
    (x = new ((() => {
      function e() {
        (this._elementsMap = new Map()),
          (this._onObservedEntry = (t) => {
            var n = this._elementsMap.get(t.target);
            null !== n
              ? n.onResize(
                  0 == t.target.clientWidth || 0 == t.target.clientHeight,
                )
              : this._resizeObserver.unobserve(t.target);
          }),
          (this._onObserved = (t) => {
            t.forEach(this._onObservedEntry);
          }),
      ...
      return (
        (e.prototype.add = function (e, t) {
          ...
          return (
            this._elementsMap.set(e, n), this._resizeObserver.observe(e), n
          );
        }),
        (e.prototype.remove = function (e) {
    ...
    (O = (() => {
      function t(e) {
        ...
        (this.loaded = !1),
          ...
          (this.onCanvasResize = (e) => {
            (this._hasZeroSize = e),
              (this._layout.maxX && this._layout.maxY) || this.resizeToCanvas();
          }),
          ...
          (this.layout = null !== (t = e.layout) && void 0 !== t ? t : new g()),
      ...
      return (
        ...
        (t.prototype.init = function (e) {
          ...
          (this.loaded = !1),
            ...
            b
              ...
              .then((e) => {
                (this.runtime = e),
                  (this.renderer = this.runtime.makeRenderer(this.canvas, f)),
                  this.canvas.width ||
                    this.canvas.height ||
                    this.resizeDrawingSurfaceToCanvas(),
                  this.initData(u, d, p, l)
        ...
        (t.prototype.setupRiveListeners = function (e) {
          if (!this.shouldDisableRiveListeners) {
            var n = (this.animator.stateMachines || [])
                .filter(
                  (e) => e.playing && this.runtime.hasListeners(e.instance),
                )
                .map((e) => e.instance),
        ...
        (t.prototype.initData = function (e, t, n, r) {
          var a;
          return d(this, void 0, void 0, function () {
            var o;
            return p(this, function (s) {
              switch (s.label) {
                ...
                case 2:
                  return (
                    ...
                    this.eventManager.fire({
                      type: i.Load,
                      data:
                        null !== (a = this.src) && void 0 !== a ? a : "buffer",
                    }),
                ...
                case 3:
                  return (
                    s.sent(),
                    console.warn((o = "Problem loading file; may be corrupt!")),
        ...
        (t.prototype.initArtboard = function (e, t, n, r) {
          if (this.file) {
            ...
            if (
              ...
              throw (this.eventManager.fire({ type: i.LoadError, data: s }), s);
            }
            (this.animator = new C(
              this.runtime,
              this.artboard,
        ...
        (t.prototype.draw = function (e, t) {
          ...
          for (
            var o = this.animator.animations
                .filter((e) => e.playing || e.needsScrub)
                .sort((e) => (e.needsScrub ? -1 : 1)),
              s = 0;
            s < o.length;
            s++
          ) {
          ...
          for (
            var c = this.animator.stateMachines.filter((e) => e.playing), h = 0;
            h < c.length;
            h++
          ) {
            var f = c[h],
            ...
            if (d)
              for (var p = 0; p < d; p++) {
                ...
                if (m) {
                  if (m.type === r.OpenUrl) {
                    if (
                      (this.eventManager.fire({ type: i.RiveEvent, data: m }),
                  ...
                  } else this.eventManager.fire({ type: i.RiveEvent, data: m });
                }
              }
            f.advance(a);
          }
        ...
        Object.defineProperty(t.prototype, "frameTime", {
          get: function () {
            return 0 === this.durations.length
              ? 0
              : (
                  this.durations.reduce((e, t) => e + t, 0) /
        ...
        (t.prototype.play = function (e, t) {
          if (((e = k(e)), !this.readyForPlaying)) {
            this.taskQueue.add({ action: () => this.play(e, t) });
            return;
          }
        ...
        (t.prototype.pause = function (e) {
          if (((e = k(e)), !this.readyForPlaying)) {
            this.taskQueue.add({ action: () => this.pause(e) });
            return;
          }
        ...
        (t.prototype.scrub = function (e, t) {
          if (((e = k(e)), !this.readyForPlaying)) {
            this.taskQueue.add({ action: () => this.scrub(e, t) });
            return;
          }
        ...
        (t.prototype.stop = function (e) {
          if (((e = k(e)), !this.readyForPlaying)) {
            this.taskQueue.add({ action: () => this.stop(e) });
            return;
          }
        ...
        (t.prototype.stateMachineInputs = function (e) {
          if (this.loaded) {
            var t = this.animator.stateMachines.find((t) => t.name === e);
    ...
    (k = (e) => ("string" == typeof e ? [e] : e instanceof Array ? e : [])),
...
//# sourceMappingURL=index.e0a37896.js.map
